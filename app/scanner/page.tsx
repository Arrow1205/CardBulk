  ...
  return (
    <div className="min-h-screen bg-[#040221] text-white font-sans pb-20 overflow-y-auto">
      ...
      <div className="px-6 space-y-8">
        ...
        <button onClick={handleSave} disabled={loading || analyzing} className="w-full bg-[#AFFF25] text-black font-black italic py-5 rounded-[24px] uppercase text-xl shadow-[0_20px_50px_rgba(175,255,37,0.2)]">
